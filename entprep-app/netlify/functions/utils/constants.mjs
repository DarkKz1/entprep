/**
 * Shared constants for Netlify Functions (runtime).
 *
 * SYNC NOTE: These constants must stay in sync with scripts/utils/constants.mjs
 * (the build-time/batch equivalent). If you change values here, update there too.
 */
